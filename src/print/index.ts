...
export { isConsoleLogEnabled, getConsoleLogTemplate, parseConsoleLogTemplate, buildConsoleLogRegex, isConsoleLogCopyToClipboardEnabled, getConsoleLogClipboardPattern, extractClipboardText } from './config'
